			...
			file->set_callback([]
				{
					...
					if (ifile.is_open())
					{
						...
						//for (const auto& obj : painter->m_objects)
						//{
						//	ifile << obj.name << "," << obj.enabled << "," << obj.paint_weight << "," << obj.random_rotation << "," << obj.align_to_ground << "," << obj.z_offset << "," << obj.random_size << "," << obj.size_range[0] << "," << obj.size_range[1] << std::endl;
						//}
