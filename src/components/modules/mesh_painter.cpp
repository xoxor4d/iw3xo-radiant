			...
			file->set_callback([]
				{
					...
					if (ofile.is_open())
					{
						...
						{
							ofile << obj.name << "," << obj.enabled << "," << obj.paint_weight << "," << obj.random_rotation << "," << obj.align_to_ground << "," << obj.z_offset << "," << obj.random_size << "," << obj.size_range[0] << "," << obj.size_range[1] /*<< "," << obj.is_prefab*/ << std::endl;
						}
