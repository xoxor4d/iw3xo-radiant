...
#pragma warning( default : 4305 4309)
				...
				else
				{
					...
					dvar = Game::Dvar_RegisterString(args[0].c_str(), args[1].c_str(), (std::int16_t)0x4000, "External Dvar");
				}
	...
	__declspec(naked) void load_config_after_fs_stub()
	{
		...
		__asm pushad
		__asm Call		Config::LoadDvars
		__asm popad

		__asm Call		R_Init_Func
		__asm jmp		retnPt
	}
	...
	void Config::WriteDvars()
	{
		...
		if (Dvars::fs_homepath)
		{
			...
			cfgFile << "// generated by IW3R" << std::endl;
